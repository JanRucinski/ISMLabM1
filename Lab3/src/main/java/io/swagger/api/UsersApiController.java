...
public class UsersApiController implements UsersApi {
    ...
    public ResponseEntity<Void> usersLoginPost(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody UsersLoginBody body
) {
